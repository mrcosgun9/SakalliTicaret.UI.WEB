...
namespace SakalliTicaret.UI.WEB.Areas.Panel.Controllers
{
    public class DefaultController : AdminControlerBase
    {
        ...
        public ActionResult ContactEdit([Bind(Include = "ID,Phone,Phone1,Mail,Mail2,Adrress,CreateDateTime,CreateUserID,UpdateDateTime,UpdateUserID")] Contact contact)
        {
